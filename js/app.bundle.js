...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_hyperapp__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__hyperapp_html__ = __webpack_require__(5);
...
var dropHandler = function (e, state, actions) {
    e.stopPropagation();
    e.preventDefault();
    var files = e.dataTransfer.files;
    __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.each(files, function (file) {
        var reader = new FileReader();
        reader.onload = function () {
            state.members = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.chain(reader.result.split('\n'))
                .tail()
                .filter(function (line) { return !__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.isEmpty(line); })
                .filter(function (line) { return line.split(',')[4] !== '参加キャンセル'; })
                .map(function (line) {
                var row = line.split(',');
...
var view = function (state, actions) {
    return Object(__WEBPACK_IMPORTED_MODULE_2__hyperapp_html__["b" /* div */])({ class: 'app' }, [
        Object(__WEBPACK_IMPORTED_MODULE_2__hyperapp_html__["b" /* div */])([
            Object(__WEBPACK_IMPORTED_MODULE_2__hyperapp_html__["c" /* h1 */])('connpassのCSVを読み込んで並べ替えるやつ'),
            Object(__WEBPACK_IMPORTED_MODULE_2__hyperapp_html__["b" /* div */])({
                class: 'droparea',
                ondragover: actions.dragover,
                ondrop: actions.drop
            }, 'connpassのCSVファイルをドロップ'),
            Object(__WEBPACK_IMPORTED_MODULE_2__hyperapp_html__["b" /* div */])({}, [Object(__WEBPACK_IMPORTED_MODULE_2__hyperapp_html__["a" /* button */])({
...
/* harmony export (immutable) */ __webpack_exports__["b"] = div;
...
/* harmony export (immutable) */ __webpack_exports__["c"] = h1;
...
/* harmony export (immutable) */ __webpack_exports__["d"] = li;
...
/* harmony export (immutable) */ __webpack_exports__["e"] = ol;
...
function vnode(tag) {
  return function (props, children) {
    return typeof props === "object" && !Array.isArray(props)
      ? Object(__WEBPACK_IMPORTED_MODULE_0_hyperapp__["b" /* h */])(tag, props, children)
      : Object(__WEBPACK_IMPORTED_MODULE_0_hyperapp__["b" /* h */])(tag, {}, props)
  }
}
